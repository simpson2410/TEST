...
namespace BioNet.Entities.Migrations
{
    ...
    [Migration("20200319132240_addduservanguoithan")]
    partial class addduservanguoithan
    {
            ...
            modelBuilder.Entity("BioNet.Entities.Entities.DanhmucNghiepvu.DanhMucPhieuSangLoc", b =>
                {
                    ...
                    b.Property<DateTime>("NgayTaoPhieu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 19, 20, 22, 40, 13, DateTimeKind.Local).AddTicks(8954));
            ...
            modelBuilder.Entity("BioNet.Entities.Entities.DanhmucNghiepvu.DanhMucTiepNhan", b =>
                {
                    ...
                    b.Property<DateTime>("NgayTiepNhan")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 19, 20, 22, 40, 23, DateTimeKind.Local).AddTicks(3610));
